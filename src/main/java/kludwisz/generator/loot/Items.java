...
public class Items {
	...
	public static final Item TRIAL_KEY = new Item("trial_key");
	
	public static final Item TUFF = new Item("tuff");
	public static final Item SCAFFOLDING = new Item("scaffolding");
	public static final Item BAMBOO_PLANKS = new Item("bamboo_planks");
	public static final Item TORCH = new Item("torch");
	public static final Item BAMBOO_HANGING_SIGN = new Item("bamboo_hanging_sign");
	...
	public static final Item AMETHYST_SHARD = new Item("amethyst_shard");
	...
	//public static final Item ARROW = new Item("diamond_block");
	public static final Item GLOW_BERRIES = new Item("glow_berries");
	public static final Item BAKED_POTATO = new Item("baked_potato");
	//public static final Item STONE_PICKAXE = new Item("diamond_block");
	//public static final Item TUFF = new Item("diamond_block");
	public static final Item ARROW_OF_POISON = new Item("poison_arrow");
	public static final Item ARROW_OF_SLOWNESS = new Item("slowness_arrow");
	public static final Item ACACIA_PLANKS = new Item("acacia_planks");
	//public static final Item TORCH = new Item("diamond_block");
	public static final Item BONE_MEAL = new Item("bone_meal");
	public static final Item MOSS_BLOCK = new Item("moss_block");
	public static final Item REGENERATION_POTION = new Item("regeneration_potion");
	public static final Item STRENGTH_POTION = new Item("strength_potion");
	public static final Item MILK_BUCKET = new Item("milk_bucket");
	
	//public static final Item BAMBOO_PLANKS = new Item("bamboo_planks");
	//public static final Item BAKED_POTATO = new Item("bamboo_planks");
	public static final Item GOLDEN_AXE = new Item("golden_axe");
	public static final Item GOLDEN_PICKAXE = new Item("golden_pickaxe");
	//public static final Item DIAMOND = new Item("bamboo_planks");
	public static final Item BUCKET = new Item("bucket");
	public static final Item COMPASS = new Item("compass");
	//public static final Item DIAMOND_PICKAXE = new Item("bamboo_planks");
	//public static final Item DIAMOND_AXE = new Item("bamboo_planks");
}