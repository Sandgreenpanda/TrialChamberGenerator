...
public class TrialChambersJigsawBlocks {
	...
	private static final List<List<JigsawBlock>> JIGSAW_BLOCKS_V2 = Arrays.<List<JigsawBlock>>asList(
			...
			Arrays.asList(new JigsawBlock(47, JointType.ALIGNED, "minecraft:empty", "minecraft:disposal", BlockDirection.UP, BlockDirection.EAST, new BPos(32, 2, 15), 0, 0),
					...
					// Index 27 (The 26 gap was between first disposal and this one)
			...
			Arrays.asList(new JigsawBlock(5, JointType.ALIGNED, "minecraft:empty", "minecraft:c1_breeze", BlockDirection.UP, BlockDirection.NORTH, new BPos(7, 1, 12), 2, 2),
					...
					new JigsawBlock(5, JointType.ROLLABLE, "minecraft:empty", "minecraft:upper_start", BlockDirection.UP, BlockDirection.EAST, new BPos(1, 13, 14), 0, 0),
					...
					new JigsawBlock(8, JointType.ROLLABLE, "minecraft:in_connector", "minecraft:entrance_cap", BlockDirection.DOWN, BlockDirection.SOUTH, new BPos(9, 13, 0), 0, 0),
					new JigsawBlock(5, JointType.ROLLABLE, "minecraft:empty", "minecraft:upper_start", BlockDirection.DOWN, BlockDirection.NORTH, new BPos(9, 13, 1), 0, 0),
					new JigsawBlock(5, JointType.ROLLABLE, "minecraft:empty", "minecraft:upper_start", BlockDirection.DOWN, BlockDirection.SOUTH, new BPos(9, 13, 27), 0, 0),
					new JigsawBlock(8, JointType.ROLLABLE, "minecraft:in_connector", "minecraft:entrance_cap", BlockDirection.DOWN, BlockDirection.NORTH, new BPos(9, 13, 28), 0, 0),
			...
			Arrays.asList(new JigsawBlock(23, JointType.ROLLABLE, "minecraft:empty", "minecraft:ominous_vault", BlockDirection.EAST, BlockDirection.UP, new BPos(6, 3, 14), 0, 0),
			...
			Arrays.asList(new JigsawBlock(19, JointType.ALIGNED, "minecraft:empty", "minecraft:decor", BlockDirection.WEST, BlockDirection.UP, new BPos(3, 1, 8), 0, 0),
			...
			Arrays.asList(new JigsawBlock(47, JointType.ALIGNED, "minecraft:empty", "minecraft:disposal", BlockDirection.UP, BlockDirection.NORTH, new BPos(5, 2, 1), 0, 0),
			...
			Collections.singletonList(new JigsawBlock(45, JointType.ROLLABLE, "minecraft:entrance_cap", "minecraft:empty", BlockDirection.NORTH, BlockDirection.UP, new BPos(2, 2, 0), 0, 0)),
			// chamber/eruption id = 6
			Arrays.asList(new JigsawBlock(9, JointType.ALIGNED, "minecraft:empty", "minecraft:center", BlockDirection.UP, BlockDirection.NORTH, new BPos(12, 0, 12), 0, 1),
			...
			Arrays.asList(new JigsawBlock(10, JointType.ALIGNED, "minecraft:empty", "minecraft:center", BlockDirection.UP, BlockDirection.NORTH, new BPos(16, 0, 15), 2, 2),
			...
			Arrays.asList(new JigsawBlock(11, JointType.ROLLABLE, "minecraft:empty", "minecraft:center", BlockDirection.UP, BlockDirection.EAST, new BPos(14, 0, 14), 0, 0),
			...
			Arrays.asList(new JigsawBlock(45, JointType.ALIGNED, "minecraft:c1_breeze", "minecraft:empty", BlockDirection.DOWN, BlockDirection.NORTH, new BPos(0, 0, 0), 0, 0),
			...
			Arrays.asList(new JigsawBlock(45, JointType.ROLLABLE, "minecraft:upper_start", "minecraft:empty", BlockDirection.WEST, BlockDirection.UP, new BPos(0, 12, 2), 0, 0),
			...
			Arrays.asList(new JigsawBlock(45, JointType.ROLLABLE, "minecraft:middle_start", "minecraft:empty", BlockDirection.EAST, BlockDirection.UP, new BPos(4, 7, 3), 0, 0),
			...
			Arrays.asList(new JigsawBlock(20, JointType.ALIGNED, "minecraft:empty", "minecraft:dispenser", BlockDirection.DOWN, BlockDirection.WEST, new BPos(1, 4, 2), 0, 0),
			...
			Collections.singletonList(new JigsawBlock(45, JointType.ROLLABLE, "minecraft:upper_start", "minecraft:empty", BlockDirection.NORTH, BlockDirection.UP, new BPos(2, 6, 0), 0, 0)),
			// chamber/addon/hanging_platform id = 14
			Collections.singletonList(new JigsawBlock(45, JointType.ROLLABLE, "minecraft:upper_addon_extension", "minecraft:empty", BlockDirection.NORTH, BlockDirection.UP, new BPos(2, 3, 0), 0, 0)),
			// chamber/addon/lower_staircase_down id = 15
			Collections.singletonList(new JigsawBlock(45, JointType.ROLLABLE, "minecraft:lower_addon_extension", "minecraft:empty", BlockDirection.EAST, BlockDirection.UP, new BPos(0, 2, 2), 0, 0)),
			// chamber/addon/short_grate_platform id = 16
			Arrays.asList(new JigsawBlock(5, JointType.ROLLABLE, "minecraft:empty", "minecraft:upper_addon_extension", BlockDirection.WEST, BlockDirection.UP, new BPos(0, 3, 2), 0, 0),
			...
			Collections.singletonList(new JigsawBlock(45, JointType.ROLLABLE, "minecraft:upper_start", "minecraft:empty", BlockDirection.WEST, BlockDirection.UP, new BPos(0, 3, 2), 0, 0)),
			// chamber/addon/walkway_with_bridge_1 id = 18
			Collections.emptyList(

			),
			// chamber/assembly/cover_1 id = 19
			Collections.singletonList(new JigsawBlock(45, JointType.ROLLABLE, "minecraft:lower_addon", "minecraft:empty", BlockDirection.DOWN, BlockDirection.NORTH, new BPos(2, 3, 2), 0, 0)),
			...
			Arrays.asList(new JigsawBlock(45, JointType.ROLLABLE, "minecraft:lower_addon", "minecraft:empty", BlockDirection.DOWN, BlockDirection.NORTH, new BPos(2, 3, 2), 0, 0),
			...
			Collections.singletonList(new JigsawBlock(45, JointType.ROLLABLE, "minecraft:lower_addon", "minecraft:empty", BlockDirection.DOWN, BlockDirection.WEST, new BPos(1, 0, 1), 0, 0)),
			// chamber/assembly/hanging_1 id = 27
			Collections.singletonList(new JigsawBlock(45, JointType.ROLLABLE, "minecraft:upper_addon", "minecraft:empty", BlockDirection.UP, BlockDirection.NORTH, new BPos(2, 3, 1), 0, 0)),
			// chamber/assembly/hanging_2 id = 28
			Collections.singletonList(new JigsawBlock(45, JointType.ROLLABLE, "minecraft:upper_addon", "minecraft:empty", BlockDirection.UP, BlockDirection.NORTH, new BPos(2, 5, 2), 0, 0)),
			// chamber/assembly/hanging_3 id = 29
			Collections.singletonList(new JigsawBlock(45, JointType.ROLLABLE, "minecraft:upper_addon", "minecraft:empty", BlockDirection.UP, BlockDirection.NORTH, new BPos(2, 4, 2), 0, 0)),
			// chamber/assembly/hanging_4 id = 30
			Collections.singletonList(new JigsawBlock(45, JointType.ROLLABLE, "minecraft:upper_addon", "minecraft:empty", BlockDirection.UP, BlockDirection.NORTH, new BPos(1, 4, 2), 0, 0)),
			// chamber/assembly/hanging_5 id = 31
			Collections.singletonList(new JigsawBlock(45, JointType.ROLLABLE, "minecraft:upper_addon", "minecraft:empty", BlockDirection.UP, BlockDirection.NORTH, new BPos(1, 0, 1), 0, 0)),
			// chamber/assembly/left_staircase_1 id = 32
			Collections.singletonList(new JigsawBlock(45, JointType.ROLLABLE, "minecraft:right_staircase", "minecraft:empty", BlockDirection.SOUTH, BlockDirection.UP, new BPos(2, 7, 10), 0, 0)),
			// chamber/assembly/left_staircase_2 id = 33
			Collections.singletonList(new JigsawBlock(45, JointType.ROLLABLE, "minecraft:right_staircase", "minecraft:empty", BlockDirection.SOUTH, BlockDirection.UP, new BPos(2, 7, 10), 0, 0)),
			// chamber/assembly/left_staircase_3 id = 34
			Arrays.asList(new JigsawBlock(25, JointType.ALIGNED, "minecraft:empty", "minecraft:spawner_connector", BlockDirection.NORTH, BlockDirection.UP, new BPos(2, 2, 8), 1, 1),
			...
			Collections.singletonList(new JigsawBlock(45, JointType.ROLLABLE, "minecraft:lower_addon", "minecraft:empty", BlockDirection.DOWN, BlockDirection.NORTH, new BPos(2, 0, 2), 0, 0)),
			// chamber/assembly/right_staircase_1 id = 36
			Collections.singletonList(new JigsawBlock(45, JointType.ROLLABLE, "minecraft:left_staircase", "minecraft:empty", BlockDirection.NORTH, BlockDirection.UP, new BPos(2, 7, 0), 0, 0)),
			// chamber/assembly/right_staircase_2 id = 37
			Collections.singletonList(new JigsawBlock(45, JointType.ROLLABLE, "minecraft:left_staircase", "minecraft:empty", BlockDirection.NORTH, BlockDirection.UP, new BPos(2, 7, 0), 0, 0)),
			// chamber/assembly/right_staircase_3 id = 38
			Arrays.asList(new JigsawBlock(25, JointType.ALIGNED, "minecraft:empty", "minecraft:spawner_connector", BlockDirection.SOUTH, BlockDirection.UP, new BPos(2, 2, 2), 1, 1),
			...
			Arrays.asList(new JigsawBlock(26, JointType.ALIGNED, "minecraft:empty", "minecraft:spawner_connector", BlockDirection.NORTH, BlockDirection.UP, new BPos(2, 4, 8), 0, 0),
			...
			Arrays.asList(new JigsawBlock(45, JointType.ALIGNED, "minecraft:center", "minecraft:empty", BlockDirection.DOWN, BlockDirection.NORTH, new BPos(0, 0, 0), 0, 0),
			...
			Collections.singletonList(new JigsawBlock(45, JointType.ROLLABLE, "minecraft:quadrant", "minecraft:empty", BlockDirection.WEST, BlockDirection.UP, new BPos(0, 5, 1), 0, 0)),
			// chamber/eruption/quadrant_2 id = 43
			Arrays.asList(new JigsawBlock(45, JointType.ROLLABLE, "minecraft:quadrant", "minecraft:empty", BlockDirection.WEST, BlockDirection.UP, new BPos(0, 5, 1), 0, 0),
			...
			Arrays.asList(new JigsawBlock(45, JointType.ROLLABLE, "minecraft:slice", "minecraft:empty", BlockDirection.NORTH, BlockDirection.UP, new BPos(2, 5, 0), 0, 0),
					new JigsawBlock(9, JointType.ROLLABLE, "minecraft:empty", "minecraft:quadrant", BlockDirection.EAST, BlockDirection.UP, new BPos(4, 5, 1), 0, 0),
			...
			Arrays.asList(new JigsawBlock(27, JointType.ALIGNED, "minecraft:empty", "minecraft:spawner_connector", BlockDirection.SOUTH, BlockDirection.UP, new BPos(2, 2, 4), 0, 0),
			...
			Arrays.asList(new JigsawBlock(45, JointType.ALIGNED, "minecraft:center", "minecraft:empty", BlockDirection.DOWN, BlockDirection.NORTH, new BPos(4, 0, 3), 2, 2),
			...
			Arrays.asList(new JigsawBlock(10, JointType.ROLLABLE, "minecraft:empty", "minecraft:quadrant", BlockDirection.WEST, BlockDirection.UP, new BPos(0, 2, 7), 0, 0),
			...
			Arrays.asList(new JigsawBlock(45, JointType.ROLLABLE, "minecraft:quadrant", "minecraft:empty", BlockDirection.WEST, BlockDirection.UP, new BPos(0, 2, 7), 0, 0),
			...
			Arrays.asList(new JigsawBlock(45, JointType.ROLLABLE, "minecraft:quadrant", "minecraft:empty", BlockDirection.WEST, BlockDirection.UP, new BPos(0, 2, 2), 0, 0),
			...
			Arrays.asList(new JigsawBlock(10, JointType.ROLLABLE, "minecraft:empty", "minecraft:quadrant", BlockDirection.WEST, BlockDirection.UP, new BPos(0, 2, 2), 0, 0),
			...
			Arrays.asList(new JigsawBlock(45, JointType.ROLLABLE, "minecraft:center", "minecraft:empty", BlockDirection.DOWN, BlockDirection.NORTH, new BPos(2, 0, 2), 0, 0),
			...
			Arrays.asList(new JigsawBlock(11, JointType.ROLLABLE, "minecraft:empty", "minecraft:quadrant", BlockDirection.WEST, BlockDirection.UP, new BPos(0, 2, 2), 0, 0),
			...
			Arrays.asList(new JigsawBlock(45, JointType.ROLLABLE, "minecraft:lower_arm", "minecraft:empty", BlockDirection.NORTH, BlockDirection.UP, new BPos(2, 2, 0), 0, 0),
					new JigsawBlock(11, JointType.ROLLABLE, "minecraft:empty", "minecraft:quadrant", BlockDirection.EAST, BlockDirection.UP, new BPos(4, 2, 7), 0, 0)),
			// chamber/slanted/hallway_4 id = 64
			Arrays.asList(new JigsawBlock(11, JointType.ROLLABLE, "minecraft:empty", "minecraft:quadrant", BlockDirection.WEST, BlockDirection.UP, new BPos(0, 2, 7), 0, 0),
					new JigsawBlock(45, JointType.ROLLABLE, "minecraft:lower_arm", "minecraft:empty", BlockDirection.NORTH, BlockDirection.UP, new BPos(2, 2, 0), 0, 0)),
			...
			Arrays.asList(new JigsawBlock(45, JointType.ROLLABLE, "minecraft:ominous_upper_arm", "minecraft:empty", BlockDirection.NORTH, BlockDirection.UP, new BPos(2, 2, 0), 0, 0),
			...
			Arrays.asList(new JigsawBlock(45, JointType.ROLLABLE, "minecraft:upper_arm", "minecraft:empty", BlockDirection.NORTH, BlockDirection.UP, new BPos(2, 2, 0), 0, 0),
			...
			Collections.singletonList(new JigsawBlock(45, JointType.ROLLABLE, "minecraft:upper_arm", "minecraft:empty", BlockDirection.NORTH, BlockDirection.UP, new BPos(2, 2, 0), 0, 0)),
			// chests/supply id = 75
			Collections.singletonList(new JigsawBlock(45, JointType.ALIGNED, "minecraft:chest", "minecraft:empty", BlockDirection.UP, BlockDirection.NORTH, new BPos(1, 1, 0), 0, 0)),
			// chests/connectors/supply id = 76
			Arrays.asList(new JigsawBlock(14, JointType.ALIGNED, "minecraft:empty", "minecraft:chest", BlockDirection.DOWN, BlockDirection.NORTH, new BPos(1, 0, 0), 0, 0),
			...
			Arrays.asList(new JigsawBlock(45, JointType.ROLLABLE, "minecraft:atrium", "minecraft:empty", BlockDirection.NORTH, BlockDirection.UP, new BPos(14, 0, 0), 1, 1),
			...
			Arrays.asList(new JigsawBlock(1, JointType.ROLLABLE, "minecraft:empty", "minecraft:second_corridor", BlockDirection.NORTH, BlockDirection.UP, new BPos(9, 0, 0), 0, 0),
			...
			Arrays.asList(new JigsawBlock(45, JointType.ROLLABLE, "minecraft:entrance", "minecraft:empty", BlockDirection.SOUTH, BlockDirection.UP, new BPos(9, 4, 18), 0, 0),
			...
			Arrays.asList(new JigsawBlock(3, JointType.ROLLABLE, "minecraft:empty", "minecraft:display", BlockDirection.WEST, BlockDirection.UP, new BPos(6, 8, 5), 0, 0),
			...
			Arrays.asList(new JigsawBlock(45, JointType.ROLLABLE, "minecraft:entrance", "minecraft:empty", BlockDirection.WEST, BlockDirection.UP, new BPos(0, 3, 9), 0, 0),
			...
			Arrays.asList(new JigsawBlock(1, JointType.ROLLABLE, "minecraft:empty", "minecraft:atrium", BlockDirection.NORTH, BlockDirection.UP, new BPos(9, 0, 0), 1, 1),
			...
			Arrays.asList(new JigsawBlock(1, JointType.ROLLABLE, "minecraft:empty", "minecraft:intersection", BlockDirection.NORTH, BlockDirection.UP, new BPos(9, 0, 0), 1, 1),
					new JigsawBlock(15, JointType.ALIGNED, "minecraft:empty", "minecraft:slice", BlockDirection.UP, BlockDirection.NORTH, new BPos(9, 0, 2), 0, 0),
					new JigsawBlock(15, JointType.ALIGNED, "minecraft:empty", "minecraft:slice", BlockDirection.UP, BlockDirection.NORTH, new BPos(9, 0, 7), 0, 0),
					new JigsawBlock(15, JointType.ALIGNED, "minecraft:empty", "minecraft:slice", BlockDirection.UP, BlockDirection.NORTH, new BPos(9, 0, 12), 0, 0),
					new JigsawBlock(15, JointType.ALIGNED, "minecraft:empty", "minecraft:slice", BlockDirection.UP, BlockDirection.NORTH, new BPos(9, 0, 17), 0, 0),
			...
			Arrays.asList(new JigsawBlock(45, JointType.ALIGNED, "minecraft:slice", "minecraft:empty", BlockDirection.DOWN, BlockDirection.NORTH, new BPos(9, 0, 2), 0, 0),
			...
			Collections.singletonList(new JigsawBlock(45, JointType.ALIGNED, "minecraft:addon", "minecraft:empty", BlockDirection.DOWN, BlockDirection.WEST, new BPos(6, 0, 1), 0, 0)),
			// corridor/addon/bridge_lower id = 94
			Collections.singletonList(new JigsawBlock(45, JointType.ALIGNED, "minecraft:addon", "minecraft:empty", BlockDirection.DOWN, BlockDirection.WEST, new BPos(6, 0, 1), 0, 0)),
			// corridor/addon/chandelier_upper id = 95
			Collections.singletonList(new JigsawBlock(45, JointType.ALIGNED, "minecraft:addon_upper", "minecraft:empty", BlockDirection.DOWN, BlockDirection.NORTH, new BPos(0, 0, 0), 0, 0)),
			// corridor/addon/decoration_upper id = 96
			Collections.singletonList(new JigsawBlock(45, JointType.ALIGNED, "minecraft:addon_upper", "minecraft:empty", BlockDirection.DOWN, BlockDirection.NORTH, new BPos(0, 0, 0), 0, 0)),
			// corridor/addon/display_1 id = 97
			Collections.singletonList(new JigsawBlock(45, JointType.ROLLABLE, "minecraft:display", "minecraft:empty", BlockDirection.EAST, BlockDirection.UP, new BPos(0, 0, 0), 0, 0)),
			...
			Collections.singletonList(new JigsawBlock(45, JointType.ALIGNED, "minecraft:addon", "minecraft:empty", BlockDirection.DOWN, BlockDirection.WEST, new BPos(0, 0, 0), 0, 0)),
			// corridor/addon/open_walkway id = 102
			Arrays.asList(new JigsawBlock(45, JointType.ROLLABLE, "minecraft:addon", "minecraft:empty", BlockDirection.DOWN, BlockDirection.NORTH, new BPos(0, 0, 0), 0, 0),
			...
			Arrays.asList(new JigsawBlock(45, JointType.ALIGNED, "minecraft:addon_upper", "minecraft:empty", BlockDirection.DOWN, BlockDirection.NORTH, new BPos(0, 0, 0), 0, 0),
			...
			Collections.singletonList(new JigsawBlock(22, JointType.ALIGNED, "minecraft:empty", "minecraft:reward_connector", BlockDirection.WEST, BlockDirection.UP, new BPos(2, 2, 1), 0, 0)),
			...
			Collections.singletonList(new JigsawBlock(45, JointType.ROLLABLE, "minecraft:relief", "minecraft:empty", BlockDirection.WEST, BlockDirection.UP, new BPos(0, 1, 2), 0, 0)),
			// corridor/atrium/breeze_relief id = 109
			Collections.singletonList(new JigsawBlock(45, JointType.ROLLABLE, "minecraft:relief", "minecraft:empty", BlockDirection.WEST, BlockDirection.UP, new BPos(0, 1, 2), 0, 0)),
			// corridor/atrium/grand_staircase_1 id = 110
			Collections.singletonList(new JigsawBlock(45, JointType.ROLLABLE, "minecraft:grand_staircase", "minecraft:empty", BlockDirection.NORTH, BlockDirection.UP, new BPos(0, 2, 0), 0, 0)),
			...
			Collections.singletonList(new JigsawBlock(45, JointType.ROLLABLE, "minecraft:relief", "minecraft:empty", BlockDirection.WEST, BlockDirection.UP, new BPos(0, 1, 2), 0, 0)),
			// decor/barrel id = 115
			Collections.singletonList(new JigsawBlock(45, JointType.ALIGNED, "minecraft:decor", "minecraft:empty", BlockDirection.WEST, BlockDirection.UP, new BPos(0, 0, 0), 0, 0)),
			...
			Collections.singletonList(new JigsawBlock(45, JointType.ALIGNED, "minecraft:dispenser", "minecraft:empty", BlockDirection.UP, BlockDirection.WEST, new BPos(1, 0, 0), 0, 0)),
			// dispensers/floor_dispenser id = 127
			Collections.singletonList(new JigsawBlock(45, JointType.ROLLABLE, "minecraft:floor_dispenser", "minecraft:empty", BlockDirection.EAST, BlockDirection.UP, new BPos(0, 1, 0), 0, 0)),
			// dispensers/wall_dispenser id = 128
			Collections.singletonList(new JigsawBlock(45, JointType.ALIGNED, "minecraft:copper_dispenser", "minecraft:empty", BlockDirection.UP, BlockDirection.WEST, new BPos(0, 0, 0), 0, 0)),
			// hallway/cache_1 id = 129
			Arrays.asList(new JigsawBlock(45, JointType.ROLLABLE, "minecraft:in_connector", "minecraft:empty", BlockDirection.NORTH, BlockDirection.UP, new BPos(2, 3, 0), 0, 0),
			...
			Arrays.asList(new JigsawBlock(4, JointType.ROLLABLE, "minecraft:empty", "minecraft:in_connector", BlockDirection.NORTH, BlockDirection.UP, new BPos(2, 3, 0), 0, 0),
			...
			Arrays.asList(new JigsawBlock(4, JointType.ROLLABLE, "minecraft:empty", "minecraft:in_connector", BlockDirection.EAST, BlockDirection.UP, new BPos(10, 3, 2), 0, 0),
			...
			Arrays.asList(new JigsawBlock(4, JointType.ROLLABLE, "minecraft:empty", "minecraft:in_connector", BlockDirection.WEST, BlockDirection.UP, new BPos(0, 3, 2), 0, 0),
			...
			Collections.singletonList(new JigsawBlock(45, JointType.ROLLABLE, "minecraft:in_connector", "minecraft:empty", BlockDirection.NORTH, BlockDirection.UP, new BPos(2, 3, 0), 0, 0)),
			...
			Arrays.asList(new JigsawBlock(45, JointType.ROLLABLE, "minecraft:upper_corridor_connector", "minecraft:empty", BlockDirection.EAST, BlockDirection.UP, new BPos(10, 3, 2), 0, 0),
			...
			Arrays.asList(new JigsawBlock(1, JointType.ROLLABLE, "minecraft:empty", "minecraft:first_corridor", BlockDirection.SOUTH, BlockDirection.UP, new BPos(9, 0, 21), 1, 1),
					...
					new JigsawBlock(46, JointType.ROLLABLE, "minecraft:empty", "minecraft:bed", BlockDirection.EAST, BlockDirection.UP, new BPos(7, 4, 8), 0, 0),
					new JigsawBlock(46, JointType.ROLLABLE, "minecraft:empty", "minecraft:bed", BlockDirection.EAST, BlockDirection.UP, new BPos(7, 4, 10), 0, 0),
					...
					new JigsawBlock(46, JointType.ROLLABLE, "minecraft:empty", "minecraft:bed", BlockDirection.WEST, BlockDirection.UP, new BPos(11, 4, 8), 0, 0),
					new JigsawBlock(46, JointType.ROLLABLE, "minecraft:empty", "minecraft:bed", BlockDirection.WEST, BlockDirection.UP, new BPos(11, 4, 10), 0, 0),
			...
			Arrays.asList(new JigsawBlock(45, JointType.ROLLABLE, "minecraft:intersection", "minecraft:empty", BlockDirection.WEST, BlockDirection.UP, new BPos(0, 0, 9), 1, 1),
			...
			Arrays.asList(new JigsawBlock(45, JointType.ROLLABLE, "minecraft:intersection", "minecraft:empty", BlockDirection.WEST, BlockDirection.UP, new BPos(0, 0, 10), 1, 1),
			...
			Collections.singletonList(new JigsawBlock(45, JointType.ROLLABLE, "minecraft:ominous_vault", "minecraft:empty", BlockDirection.NORTH, BlockDirection.UP, new BPos(1, 1, 0), 0, 0)),
			// reward/vault id = 150
			Collections.singletonList(new JigsawBlock(45, JointType.ROLLABLE, "minecraft:reward_connector", "minecraft:empty", BlockDirection.NORTH, BlockDirection.UP, new BPos(1, 2, 0), 0, 0)),
			// spawner/breeze/breeze id = 151
			Collections.singletonList(new JigsawBlock(45, JointType.ALIGNED, "minecraft:spawner", "minecraft:empty", BlockDirection.UP, BlockDirection.NORTH, new BPos(1, 1, 0), 0, 0)),
			// spawner/connectors/breeze id = 152
			Arrays.asList(new JigsawBlock(31, JointType.ALIGNED, "minecraft:empty", "minecraft:spawner", BlockDirection.DOWN, BlockDirection.NORTH, new BPos(1, 0, 0), 0, 0),
			...
			Arrays.asList(new JigsawBlock(/* USES ALIAS spawner/contents/melee HUSK */ 32, JointType.ALIGNED, "minecraft:empty", "minecraft:spawner", BlockDirection.DOWN, BlockDirection.NORTH, new BPos(1, 0, 0), 0, 0),
					new JigsawBlock(45, JointType.ROLLABLE, "minecraft:spawner_connector", "minecraft:empty", BlockDirection.NORTH, BlockDirection.UP, new BPos(1, 0, 2), 0, 0)),
			// spawner/connectors/ranged id = 154
			Arrays.asList(new JigsawBlock(/* USES ALIAS spawner/contents/ranged BOGGED */ 35, JointType.ALIGNED, "minecraft:empty", "minecraft:spawner", BlockDirection.DOWN, BlockDirection.NORTH, new BPos(1, 0, 0), 0, 0),
					new JigsawBlock(45, JointType.ROLLABLE, "minecraft:spawner_connector", "minecraft:empty", BlockDirection.NORTH, BlockDirection.UP, new BPos(1, 0, 2), 0, 0)),
			// spawner/connectors/slow_ranged id = 155
			Arrays.asList(new JigsawBlock(/* USES ALIAS spawner/contents/slow_ranged BOGGED */ 38, JointType.ALIGNED, "minecraft:empty", "minecraft:spawner", BlockDirection.DOWN, BlockDirection.NORTH, new BPos(1, 0, 0), 0, 0),
					new JigsawBlock(45, JointType.ROLLABLE, "minecraft:spawner_connector", "minecraft:empty", BlockDirection.NORTH, BlockDirection.UP, new BPos(1, 0, 2), 0, 0)),
			// spawner/connectors/small_melee id = 156
			Arrays.asList(new JigsawBlock(/* USES ALIAS spawner/contents/small_melee BABY ZOMBIE */ 41, JointType.ALIGNED, "minecraft:empty", "minecraft:spawner", BlockDirection.DOWN, BlockDirection.NORTH, new BPos(1, 0, 0), 0, 0),
					new JigsawBlock(45, JointType.ROLLABLE, "minecraft:spawner_connector", "minecraft:empty", BlockDirection.NORTH, BlockDirection.UP, new BPos(1, 0, 2), 0, 0)),
			...
			Arrays.asList(new JigsawBlock(45, JointType.ROLLABLE, "minecraft:in_connector", "minecraft:empty", BlockDirection.EAST, BlockDirection.UP, new BPos(11, 2, 13), 0, 0),
			...
			Arrays.asList(new JigsawBlock(20, JointType.ALIGNED, "minecraft:empty", "minecraft:copper_dispenser", BlockDirection.DOWN, BlockDirection.EAST, new BPos(1, 2, 10), 0, 0),
			...
			Arrays.asList(new JigsawBlock(45, JointType.ROLLABLE, "minecraft:in_connector", "minecraft:empty", BlockDirection.NORTH, BlockDirection.UP, new BPos(4, 2, 0), 0, 0),
			...
			Arrays.asList(new JigsawBlock(22, JointType.ALIGNED, "minecraft:empty", "minecraft:reward_connector", BlockDirection.EAST, BlockDirection.UP, new BPos(4, 2, 9), 0, 0),
			...
			Arrays.asList(new JigsawBlock(2, JointType.ALIGNED, "minecraft:empty", "minecraft:decor", BlockDirection.WEST, BlockDirection.UP, new BPos(11, 0, 10), 0, 0),
			...
			Arrays.asList(new JigsawBlock(4, JointType.ROLLABLE, "minecraft:empty", "minecraft:in_connector", BlockDirection.EAST, BlockDirection.UP, new BPos(10, 13, 2), 0, 0),
			...
			// beds
			Collections.singletonList(new JigsawBlock(45, JointType.ROLLABLE, "minecraft:bed", "minecraft:empty", BlockDirection.NORTH, BlockDirection.UP, new BPos(0, 1, 0), 0, 0)),
			Collections.singletonList(new JigsawBlock(45, JointType.ROLLABLE, "minecraft:bed", "minecraft:empty", BlockDirection.NORTH, BlockDirection.UP, new BPos(0, 1, 0), 0, 0)),
			Collections.singletonList(new JigsawBlock(45, JointType.ROLLABLE, "minecraft:bed", "minecraft:empty", BlockDirection.NORTH, BlockDirection.UP, new BPos(0, 1, 0), 0, 0)),
			Collections.singletonList(new JigsawBlock(45, JointType.ROLLABLE, "minecraft:bed", "minecraft:empty", BlockDirection.NORTH, BlockDirection.UP, new BPos(0, 1, 0), 0, 0)),
			...
			// disposal
			Collections.singletonList(new JigsawBlock(45, JointType.ALIGNED, "minecraft:disposal", "minecraft:empty", BlockDirection.DOWN, BlockDirection.EAST, new BPos(0, 2, 0), 0, 0)));
		...
		for (int i = 0; i < JIGSAW_BLOCKS_V2.size(); i++) {
			...
			for (JigsawBlock parentJigsaw : JIGSAW_BLOCKS_V2.get(i)) {
				...
				for (Pair<Integer, Integer> pair : TrialChambersPools.get(parentJigsaw.poolType)) {// line 1443
					...
					if (childPieceId == TrialChambersGenerator.EMPTY_PIECE_ID)
						continue;
					...
					for (BlockRotation childPieceRotation : BlockRotation.values()) {
						for (JigsawBlock childJigsaw : JIGSAW_BLOCKS_V2.get(childPieceId)) {
							if (!childJigsaw.name.equals(parentJigsaw.targetName))
								continue;
							if (childJigsaw.direction1.getAxis() == BlockDirection.Axis.Y)
								continue;
							if (childPieceRotation.rotate(childJigsaw.direction1) != parentJigsaw.direction1.getOpposite())
								continue;
	...
	static {
		for (int pieceID = 0; pieceID < 193; pieceID++) { // idk, but i added until 193 ids
			...
			pieceJigsaws.sort(Comparator.comparingInt((var0x) -> -var0x.selectionPriority));
